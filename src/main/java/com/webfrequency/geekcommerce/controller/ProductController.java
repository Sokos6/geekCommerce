...
import com.webfrequency.geekcommerce.exception.NoProductsFoundUnderCategoryException;
...
public class ProductController {
	...
	public String processAddNewProductForm(@ModelAttribute("newProduct") @Valid Product productToBeAdded, BindingResult result,
		...
		if (productImage != null && !productImage.isEmpty()) {
			try {
				productImage
						.transferTo(new File(rootDirectory + "\\geekcommerce\\images\\" + productToBeAdded.getProductId() + ".png"));
			} catch (Exception e) {
